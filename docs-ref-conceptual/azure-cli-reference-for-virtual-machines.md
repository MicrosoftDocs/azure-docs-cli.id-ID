...
| [az desktopvirtualization hostpool](/cli/azure/desktopvirtualization/hostpool) | Mengelola kumpulan host virtualisasi desktop. |
...
|-|-|-|
| [az image](/cli/azure/image) | Mengelola citra mesin virtual kustom. | [Cara membuat citra komputer virtual atau VHD](/azure/virtual-machines/linux/capture-image) |
| [az image builder](/cli/azure/image/builder) | Mengelola dan membuat templat penyusun citra. |  |
| [az image builder customizer](/cli/azure/image/builder/customizer) | Mengelola penyesuai templat penyusun citra. |  |
| [az image builder output](/cli/azure/image/builder/output) | Mengelola distributor output templat penyusun citra. |  |
...
| [az maintenance assignment](/cli/azure/maintenance/assignment) | Mengelola penetapan konfigurasi pemeliharaan. | [Mengontrol pembaruan dengan Kontrol Pemeliharaan dan Azure CLI](/azure/virtual-machines/maintenance-control-cli) |
...
| Referensi | Deskripsi | Informasi selengkapnya |
|-|-|-|
| [az sig](/cli/azure/sig) | Mengelola galeri citra bersama. | [Tutorial: Membuat dan menggunakan gambar kustom untuk set skala komputer virtual dengan antarmuka tingkat panggilan Azure](/azure/virtual-machine-scale-sets/tutorial-use-custom-image-cli) |
| [az sig image-definition](/cli/azure/sig/image-definition) | Mengelola definisi citra di galeri citra bersama. | [Tutorial: Membuat dan menggunakan gambar kustom untuk set skala komputer virtual dengan antarmuka tingkat panggilan Azure](/azure/virtual-machine-scale-sets/tutorial-use-custom-image-cli) |
| [az sig image-version](/cli/azure/sig/image-version) | Mengelola versi citra dalam definisi citra. | [Tutorial: Membuat dan menggunakan gambar kustom untuk set skala komputer virtual dengan antarmuka tingkat panggilan Azure](/azure/virtual-machine-scale-sets/tutorial-use-custom-image-cli) |
| [az sig share](/cli/azure/sig/share) | Mengelola profil berbagi galeri citra bersama. |  |
...
|-|-|-|-|
| [az vm](/cli/azure/vm) | Mengelola mesin virtual Windows atau Linux. | | [Tutorial: Membuat dan menggunakan gambar kustom untuk set skala komputer virtual dengan antarmuka tingkat panggilan Azure](/azure/virtual-machine-scale-sets/tutorial-use-custom-image-cli) |
| [az vm aem](/cli/azure/vm/aem) | Mengelola Azure Enhanced Monitoring for SAP untuk mesin virtual. | aem |  |
...
| [az vm boot-diagnostics](/cli/azure/vm/boot-diagnostics) | Mengelola diagnostik boot untuk mesin virtual. | | |
| [az vm diagnostics](/cli/azure/vm/diagnostics) | Mengelola pengaturan ekstensi diagnostik untuk mesin virtual. | | |
| [az vm disk](/cli/azure/vm/disk) | Melampirkan atau melepaskan disk data terkelola pada mesin virtual. | | [Aktifkan bursting sesuai permintaan](/azure/virtual-machines/disks-enable-bursting?tabs=azure-cli) |
...
| [az vm extension](/cli/azure/vm/extension) | Mengelola ekstensi untuk mesin virtual. | | [Ekstensi dan fitur mesin virtual untuk Linux](/azure/virtual-machines/extensions/features-linux) |
| [az vm extension image](/cli/azure/vm/extension/image) | Menemukan ekstensi yang tersedia untuk mesin virtual. | | [Ekstensi dan fitur mesin virtual untuk Linux](/azure/virtual-machines/extensions/features-linux) |
| [az vm host](/cli/azure/vm/host) | Mengelola host khusus untuk mesin virtual. | | [Terapkan pada host khusus menggunakan Azure CLI](/azure/virtual-machines/linux/dedicated-hosts-cli) |
| [az vm host group](/cli/azure/vm/host/group) | Mengelola grup host khusus untuk mesin virtual. | | [Terapkan pada host khusus menggunakan Azure CLI](/azure/virtual-machines/linux/dedicated-hosts-cli) |
...
| [az vm image](/cli/azure/vm/image) | Menampilkan informasi tentang citra mesin virtual yang tersedia. | | [Menemukan informasi citra Azure Marketplace menggunakan Azure CLI](/azure/virtual-machines/linux/cli-ps-findimage) |
| [az vm image terms](/cli/azure/vm/image/terms) | Mengelola ketentuan citra Azure Marketplace. | | [Menemukan informasi citra Azure Marketplace menggunakan Azure CLI](/azure/virtual-machines/linux/cli-ps-findimage) |
| [az vm monitor log](/cli/azure/vm/monitor/log) | Menampilkan ruang kerja analitik log untuk mesin virtual. | | |
| [az vm monitor metrics](/cli/azure/vm/monitor/metrics) | Menampilkan metrik untuk mesin virtual. | | |
...
| [az vm repair](/cli/azure/vm/repair) | Mengelola perbaikan mesin virtual dan skrip. | vm-repair | |
| [az vm run-command](/cli/azure/vm/run-command) | Mengelola perintah yang dijalankan untuk mesin virtual. | | [Memutar sertifikat di Azure Kubernetes Service](/azure/aks/certificate-rotation) |
...
| [az vm unmanaged-disk](/cli/azure/vm/unmanaged-disk) | Mengelola disk data yang tidak dikelola untuk mesin virtual. | | [Perencanaan dan penerapan Microsoft Azure Virtual Machines Azure untuk SAP NetWeaver](/azure/virtual-machines/workloads/sap/planning-guide) |
| [az vm user](/cli/azure/vm/user) | Mengelola akun pengguna untuk mesin virtual. | | [Mengelola pengguna administratif, SSH, dan memeriksa atau memperbaiki disk di mesin virtual Linux menggunakan Ekstensi VMAccess dengan Azure CLI](/azure/virtual-machines/extensions/vmaccess) |

## <a name="virtual-machine-scale-set-references"></a>Referensi set skala mesin virtual

| Referensi | Deskripsi | Informasi selengkapnya |
|-|-|-|
| [az vmss](/cli/azure/vmss) | Mengelola set skala mesin virtual Azure. | [Mulai Cepat: Membuat set skala komputer virtual dengan Azure CLI](/azure/virtual-machine-scale-sets/quick-create-cli) |
| [az vmss diagnostics](/cli/azure/vmss/diagnostics) | Mengonfigurasi ekstensi Azure Diagnostics untuk set skala mesin virtual. | |
| [az vmss disk](/cli/azure/vmss/disk) | Mengelola disk data untuk set skala mesin virtual. | [Tutorial: Membuat dan mengelola set skala komputer virtual dengan antarmuka tingkat panggilan Azure](/azure/virtual-machine-scale-sets/tutorial-use-disks-cli) |
| [az vmss encryption](/cli/azure/vmss/encryption) | Mengelola enkripsi untuk set skala mesin virtual. | [Mengenkripsi OS dan disk data terlampir dalam skala komputer virtual yang diatur dengan Azure PowerShell](/azure/virtual-machine-scale-sets/disk-encryption-cli) |
| [az vmss extension](/cli/azure/vmss/extension) | Mengelola ekstensi untuk set skala mesin virtual. | [Mulai Cepat: Membuat set skala komputer virtual dengan Azure CLI](/azure/virtual-machine-scale-sets/quick-create-cli) |
| [az vmss extension image](/cli/azure/vmss/extension/image) | Menampilkan informasi tentang citra ekstensi yang tersedia untuk set skala mesin virtual. | |
| [az vmss identity](/cli/azure/vmss/identity) | Mengelola identitas layanan untuk set skala mesin virtual. | [Membuat dan mengelola set skala komputer virtual Azure](/azure/virtual-machine-scale-sets/scripts/cli-sample-manage-scale-set) |
| [az vmss nic](/cli/azure/vmss/nic) | Mengelola antarmuka jaringan untuk set skala mesin virtual. | |
| [az vmss rolling-upgrade](/cli/azure/vmss/rolling-upgrade) | Mengelola peningkatan bergulir untuk set skala mesin virtual. | |
| [az vmss run-command](/cli/azure/vmss/run-command) | Mengelola perintah jalankan untuk set skala mesin virtual. | |
...
| [az serial-console](/cli/azure/serial-console) | Mengelola Azure Serial Console untuk mesin virtual atau set skala mesin virtual. | serial-console | |
| [az serial-console send](/cli/azure/serial-console/send) | Menggunakan Azure Serial Console untuk mengirim perintah ke mesin virtual atau set skala mesin virtual. | serial-console | |
| [az ssh](/cli/azure/ssh) | Mengelola konfigurasi SSH. | ssh | [Masuk ke mesin virtual Linux di Azure dengan Azure Active Directory menggunakan autentikasi berbasis sertifikat SSH](/azure/active-directory/devices/howto-vm-sign-in-azure-ad-linux) |
| [az sshkey](/cli/azure/sshkey) | Mengelola konfigurasi kunci umum SSH. | | |
